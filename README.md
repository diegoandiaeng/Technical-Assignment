...
- Notebook for data_preprocessing takes pre sampled point clouds of 5000 point + output fields (Rpt0_N5000.npz) and csv file with global scalars (bracket_labels.csv) and performs data preprocessing including splits and normalization: data_preprocessing.ipynb
